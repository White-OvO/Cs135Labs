...
*/
// plush input
    int PlushPackQuantity = 0;
    double plushPackCost = 0.0;


    cout << "Plush pack quantity: " ;
    cin >> PlushPackQuantity;
    cout <<"Plush pack cost: ";
    cin >> plushPackCost;


    int ActionFigurePackQuantity =0;
    double actionFigurePackCost=0.0;
// action figure pack 
...
// puzzle pack
    int puzzlePackQuantity=0;
    double puzzlePackCost=0.0;
    ...
    cout << string(5,'-') << "SunnyToyShopMonthlySalesReport" << string(5,'-') << endl;
    ...
    cout << "Total Sale Price:(Revenue): $" << TOTAL_SALE_PRICE_PLUSHIES << endl;
    ...
    cout << "Single Toy Sale Price: $" << SALE_PRICE_PER_TOY_ACTION_FIGURES << endl;
    cout << "Total Sale Price:(Revenue): $" << TOTAL_SALE_PRICE_ACTION_FIGURES << endl;
    ...
    cout << "Single Toy Sale Price: $" << SALE_PRICE_PER_TOY_PUZZLES << endl;
    cout << "Total Sale Price:(Revenue): $" << TOTAL_SALE_PRICE_PUZZLES << endl;
    ...
    cout << "Total Sale Price (Revenue): $" << TOTAL_SALE_PRICE_ACTION_FIGURES + TOTAL_SALE_PRICE_PLUSHIES + TOTAL_SALE_PRICE_PUZZLES << endl;
    cout << "Total Profit: $" << TOTAL_PROFIT_ACTION_FIGURES + TOTAL_PROFIT_PLUSHIES + TOTAL_PROFIT_PUZZLES << endl;
     return 0; 
